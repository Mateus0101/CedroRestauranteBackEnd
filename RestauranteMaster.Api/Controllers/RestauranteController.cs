...
namespace RestauranteMaster.Api.Controllers
{
    public class RestauranteController : BaseController
    {
        ...
        public Task<HttpResponseMessage> deleteRestaurante(string nome) // Deleta o restaurante
        {
            var response = new HttpResponseMessage();
            try
            {
